CREATE DATABASE  IF NOT EXISTS `hsppedidos` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `hsppedidos`;
...
INSERT INTO `hsdsucursales` VALUES (1,1,'Guerrero',1,1,1,'0000-00-00 00:00:00','2018-04-04 23:56:02'),(2,1,'Colon',0,1,1,'2018-04-04 23:47:15','2018-04-05 03:15:15');
...
CREATE TABLE `hspclientes` (
  ...
  `entre_calles` varchar(150) DEFAULT NULL,
  `idestatus` int(11) NOT NULL,
  `idusuario_alta` int(11) NOT NULL,
  `idusuario_um` int(11) DEFAULT NULL,
...
INSERT INTO `hspclientes` VALUES (1,1,'Mostrador',NULL,NULL,NULL,NULL,1,1,1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(6,1,'Juan Hernandez','','','','',1,1,1,'2018-04-05 03:11:28','2018-04-05 03:37:29');
...
INSERT INTO `hspempresas` VALUES (1,'Tacos Charly','1','0000-00-00 00:00:00'),(2,'Mi Fonda','d7d0ea234282ba32306f080d2e8c801f.b84c1f59c364bc277d0d321b4263d79528b26289','2018-04-05 04:03:28');
...
INSERT INTO `hspmesas` VALUES (1,1,1,'V','Mesa 2',1,1,'2018-04-05 05:35:41',NULL,NULL),(2,1,1,'F','Mesa 1',1,1,'2018-04-05 05:36:03',1,'2018-04-05 05:49:59'),(3,1,3,'F','Mesa 3',0,1,'2018-04-05 05:36:30',1,'2018-04-05 05:54:07'),(4,1,4,'F','Mesa 4',1,1,'2018-04-05 06:54:00',NULL,NULL);
...
-- Dump completed on 2018-04-05  2:13:19
