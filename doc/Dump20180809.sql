...
--
-- Table structure for table `pcusuarios`
--

DROP TABLE IF EXISTS `pcusuarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pcusuarios` (
  ...
  `claveTemp` varchar(32) DEFAULT NULL,
  `keyToken` varchar(254) NOT NULL,
  ...
  KEY `BUSQUEDA` (`nickname`,`nombre`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pcusuarios`
--

LOCK TABLES `pcusuarios` WRITE;
/*!40000 ALTER TABLE `pcusuarios` DISABLE KEYS */;
INSERT INTO `pcusuarios` VALUES (1,'admin',NULL,'admin','285e476a3a0b754a19f58327587a2e83','285e476a3a0b754a19f58327587a2e83','285e476a3a0b754a19f58327587a2e83',1,1,1,'2018-08-09 20:41:26',0,NULL),(2,'demo',NULL,'demo','285e476a3a0b754a19f58327587a2e83','285e476a3a0b754a19f58327587a2e83','285e476a3a0b754a19f58327587a2e83',1,1,1,'2018-08-09 20:41:26',0,NULL);
/*!40000 ALTER TABLE `pcusuarios` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-08-09 21:23:17
...
INSERT INTO `mesas` VALUES (1,'Mesa 1',1,1,'2018-07-20 22:10:00',1,'2018-07-20 22:10:00'),(2,'Mesa 2',1,1,'2018-08-08 19:45:28',1,'2018-08-08 19:45:28');
